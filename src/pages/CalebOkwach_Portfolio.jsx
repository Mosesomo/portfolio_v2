...
const PROJECTS = [
  { id:1, title:"Timwa Fisheries", image:"/src/assets/timwafiheries.png", url:"https://timwafisheries.com", category:"Web Development", desc:"Professional website for a fisheries business — showcasing products, services and enabling customer inquiries.", tech:["Web Design","CMS","SEO"] },
  { id:2, title:"Restorative Psychology", image:"/src/assets/restorative.png", url:"https://restorative-psych.com/", category:"Web Development", desc:"Clinical psychology practice website with service listings, professional bios, and appointment booking.", tech:["React","UI/UX","CMS"] },
  { id:3, title:"Ideal Psychology", image:"/src/assets/ideal.png", url:"https://idealpsych.com/", category:"Web Development", desc:"Modern psychology and mental health practice site featuring patient resources and contact forms.", tech:["Web Design","WordPress","SEO"] },
  { id:4, title:"Beacon of Strength", image:"/src/assets/beacon.png", url:"https://beacob-of-strength.vercel.app/", category:"Web Development", desc:"A motivational platform connecting communities with resources for mental wellness and resilience.", tech:["React","Tailwind CSS","Vercel"] },
  ...
  { id:6, title:"Brand Identity", image:"/src/assets/graphic/design_1.jpeg", url:"#", category:"Graphic Design", desc:"Complete brand identity design — logo, color palette, typography, and brand guidelines.", tech:["Logo","Color Palette","Typography"] },
  { id:7, title:"Packaging Design", image:"/src/assets/graphic/design_2.jpeg", url:"#", category:"Graphic Design", desc:"Product packaging design with label layout, promotional flyers, and 3D mockups.", tech:["Label","Mockups","Print"] },
  { id:8, title:"Social Media Graphics", image:"/src/assets/graphic/design_3.jpeg", url:"#", category:"Graphic Design", desc:"Engaging social media graphics and campaigns for Instagram, Facebook and other platforms.", tech:["Instagram","Facebook","Campaigns"] },
  { id:9, title:"Print Collateral", image:"/src/assets/graphic/design_4.jpeg", url:"#", category:"Graphic Design", desc:"Print materials including brochures, flyers, business cards, and promotional items.", tech:["Brochure","Flyers","Business Cards"] },
  { id:10, title:"Logo Design", image:"/src/assets/graphic/design_5.jpeg", url:"#", category:"Graphic Design", desc:"Custom vector logo design — brand marks, monograms, and visual identity systems.", tech:["Vector","Brand Mark","Monogram"] },
  { id:11, title:"Digital Illustrations", image:"/src/assets/graphic/design_6.jpeg", url:"#", category:"Graphic Design", desc:"Digital vector illustrations and artwork created with Illustrator and Canva.", tech:["Vector Art","Canva","Illustrator"] },
  { id:12, title:"Packaging Mockup", image:"/src/assets/graphic/design_7.jpeg", url:"#", category:"Graphic Design", desc:"3D product mockups and packaging design for consumer brands and products.", tech:["3D Mockup","Product","Box Design"] },
  { id:13, title:"Brand Guidelines", image:"/src/assets/graphic/design_8.jpeg", url:"#", category:"Graphic Design", desc:"Comprehensive brand style guides with colors, typography and usage standards.", tech:["Style Guide","Colors","Typography"] },
  { id:14, title:"Marketing Materials", image:"/src/assets/graphic/design_9.jpeg", url:"#", category:"Graphic Design", desc:"Marketing collateral — brochures, banners, ads and promotional campaigns.", tech:["Brochure","Banner","Ads"] },
  { id:15, title:"UI Graphics", image:"/src/assets/graphic/design_10.jpeg", url:"#", category:"Graphic Design", desc:"Custom icons, illustrations, and web graphics for digital products and interfaces.", tech:["Icons","Illustrations","Web Graphics"] },
  { id:16, title:"Poster Design", image:"/src/assets/graphic/design_11.jpeg", url:"#", category:"Graphic Design", desc:"Event posters, A3 prints and promotional materials with bold visual design.", tech:["A3 Poster","Event","Promotion"] },
  { id:17, title:"Custom Illustrations", image:"/src/assets/graphic/design_12.jpeg", url:"#", category:"Graphic Design", desc:"Bespoke vector illustrations for brands, websites, and custom art projects.", tech:["Vector","Custom Art","Brand"] },
  { id:18, title:"E-Commerce Shop", image:"/src/assets/ecommerce.png", url:"https://shop-carlteq-two.vercel.app/", category:"Web Development", desc:"Full-featured online store with product catalog, cart, checkout, and payment gateway integration.", tech:["React","E-Commerce","Stripe"] },
  { id:19, title:"Treasury Simulator", image:"/src/assets/simulator.png", url:"https://treasurery-simulator-niobi-assessme.vercel.app/", category:"Web Development", desc:"Financial simulation dashboard for treasury management — tracking assets, risk analysis, and portfolio performance.", tech:["React","Finance","Dashboard"] },
...
const GRAPHIC_PROJECTS = [
  { id:1, image:"/src/assets/graphic/design_1.jpeg", title:"Brand Identity", tech:["Logo","Color Palette","Typography"] },
  { id:2, image:"/src/assets/graphic/design_2.jpeg", title:"Packaging Design", tech:["Label","Mockups","Print"] },
  { id:3, image:"/src/assets/graphic/design_3.jpeg", title:"Social Media Graphics", tech:["Instagram","Facebook","Campaigns"] },
  { id:4, image:"/src/assets/graphic/design_4.jpeg", title:"Print Collateral", tech:["Brochure","Flyers","Business Cards"] },
  { id:5, image:"/src/assets/graphic/design_5.jpeg", title:"Logo Design", tech:["Vector","Brand Mark","Monogram"] },
  { id:6, image:"/src/assets/graphic/design_6.jpeg", title:"Digital Illustrations", tech:["Vector Art","Canva","Illustrator"] },
  { id:7, image:"/src/assets/graphic/design_7.jpeg", title:"Packaging Mockup", tech:["3D Mockup","Product","Box Design"] },
  { id:8, image:"/src/assets/graphic/design_8.jpeg", title:"Brand Guidelines", tech:["Style Guide","Colors","Typography"] },
  { id:9, image:"/src/assets/graphic/design_9.jpeg", title:"Marketing Materials", tech:["Brochure","Banner","Ads"] },
  { id:10, image:"/src/assets/graphic/design_10.jpeg", title:"UI Graphics", tech:["Icons","Illustrations","Web Graphics"] },
  { id:11, image:"/src/assets/graphic/design_11.jpeg", title:"Poster Design", tech:["A3 Poster","Event","Promotion"] },
  { id:12, image:"/src/assets/graphic/design_12.jpeg", title:"Custom Illustrations", tech:["Vector","Custom Art","Brand"] },
];
